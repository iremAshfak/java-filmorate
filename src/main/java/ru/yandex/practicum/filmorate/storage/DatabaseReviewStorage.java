...
@Repository
public class DatabaseReviewStorage extends DatabaseStorage<Review> implements ReviewStorage {
    ...
    public DatabaseReviewStorage(JdbcTemplate jdbc, RowMapper<Review> mapper) {
        super(jdbc, mapper);
    }
